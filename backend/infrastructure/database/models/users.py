...
class User(Base, TimestampMixin):
    ...
    auto_transcription: Mapped[bool] = mapped_column(BOOLEAN, server_default=false())
    auto_speech: Mapped[bool] = mapped_column(BOOLEAN, server_default=false())
    single_message: Mapped[bool] = mapped_column(BOOLEAN, server_default=false())
